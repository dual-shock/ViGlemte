...
void setup()
{
  ...
  Serial.println("reaches here 0");

	if (!DFPlayer.begin(DFPlayer_serial)) // ? inits DFPlayer
	{ // ? if init fails
		Serial.println("DFPlayer Mini not found!");
	}
  Serial.println("reaches here 0.1");
  ...
  Serial.println("reaches here 0.2");

  Serial.println("reaches here 0.3");
  Serial.println("reaches here 1");
...
void loop()
{
	...
	// TODO if the sensor after the opening of the respecive day is opened within
	// TODO 5 minutes of the first opening, disregard that first opening
  Serial.println("test if reaches loop");
	// * looping values
	now = rtc.now();
